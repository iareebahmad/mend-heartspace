    ...
    <Layout>
      ...
      <section className="gradient-hero min-h-[80vh] flex items-center relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-20 right-10 w-80 h-80 rounded-full bg-mint-200/30 blur-3xl animate-float" style={{ animationDelay: "1s" }} />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Private. Non-judgmental. Always here when you need to talk.
            </motion.p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            <FeatureCard
              ...
              description="Reflect on your feelings through gentle, guided conversations. MEND listens without judgment and helps you understand what you're experiencing."
              variant="lilac"
              delay={0}
            />
            <FeatureCard
              ...
              description="Discover emotional patterns over time. Understand your triggers, track your moods, and gain insights that empower positive change."
              variant="mint"
              delay={0.1}
            />
            <FeatureCard
              icon={Users}
              title="Human Support"
              description="Connect with verified mental health experts for focused micro-sessions when you need professional guidance and support."
              variant="peach"
              delay={0.2}
            />
          </div>
